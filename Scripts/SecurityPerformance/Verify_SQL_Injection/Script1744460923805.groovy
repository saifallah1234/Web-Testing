...
WebUI.setText(findTestObject('Object Repository/Page_My account - Vervane/Page_My account - Vervane/input_Obligatoire_username'), "' OR '1'='1")
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_My account - Vervane/Page_My account - Vervane/input_Obligatoire_username'), 5)
