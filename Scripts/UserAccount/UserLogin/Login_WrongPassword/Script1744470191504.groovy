...
WebUI.setText(findTestObject('Object Repository/Page_My account - Vervane/Page_My account - Vervane/input_Obligatoire_password'),
	'abcdefg2')

WebUI.click(findTestObject('Object Repository/Page_My account - Vervane/Page_My account - Vervane/button_Se connecter'))


WebUI.verifyElementText(findTestObject('Object Repository/Page_My account - Vervane/Page_Vervane Vervane/ul_Erreur le mot de passe que vous avez saisi pour ladresse e-mail saifallahbellhaj2017gmail.com est incorrect. Mot de passe oubli'), 
    'Erreur : le mot de passe que vous avez saisi pour l’adresse e-mail saifallahbellhaj2017@gmail.com est incorrect. Mot de passe oublié ?')
WebUI.closeBrowser()